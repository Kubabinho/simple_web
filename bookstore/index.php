...
?>
<html style="background-image: url(banner.png); background-size: cover;">
    <head>
    ...
    <body>
        <div class="container">
            <form method="post" action="">
                <div id="div_login">
                    <h1>Login into bookstore</h1>
                    <div>
                        <input type="text" class="textbox" id="txt_uname" name="txt_uname" placeholder="Login" />
                    </div>
                    <div>
                        <input type="password" class="textbox" id="txt_uname" name="txt_pwd" placeholder="Hasło"/>
                    </div>
                    <div>
